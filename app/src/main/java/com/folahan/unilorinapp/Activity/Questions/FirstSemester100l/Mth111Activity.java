...
public class Mth111Activity extends AppCompatActivity {
    ...
    private void getQuestionPhase(List<Question> list) {
        ...
        questionList.add(new Question("The sun substend an angle at 35o from the center of the earth whose distant from the centre of " +
        ...
        questionList.add(new Question("If α and β are roots of the equation 3x^2" +
                "-7x – 1 = 0 find the value of α²+ β²",
                "(a) 61/9", "(b) -61/9",
                "(c)55/9",
                "(d) -55/9",
