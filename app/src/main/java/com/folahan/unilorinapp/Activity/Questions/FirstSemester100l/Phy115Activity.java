...
public class Phy115Activity extends AppCompatActivity {
    ...
    private void getQuestionPhase(List<Question> list) {
        ...
        questionList.add(new Question("Convert 0.25rev to degrees",
                "A. 13.25",
                "B. 14.33",
                "C. 12.47",
                "D. 11.23",
        ...
        questionList.add(new Question("The period of a string is 2s. If the length of the string is doubled, what is the new period",
                "A. 1.41s",
                "B. 2.83s",
                "C. 2.00s",
                "D. 4.00s",
        ...
        questionList.add(new Question("Shear strain is________",
                "A. tanα",
                "B. sincosα",
                "C. cos&sinα",
                "D. cosα",
        ...
        questionList.add(new Question("Which of the following is correct about inelastic collision\n" +
        ...
        questionList.add(new Question("Find the acceleration of a body with initial velocity, u=-3.2i+6.0j and it increased to a final velocity, v=2.9i-4.1j within 5s",
                "A. 0.68",
                "B. 0.94",
                "C. 2.36",
                "D. 2.56",
        ...
        questionList.add(new Question("What is the potential energy at point r if the force is f= -k/r²",
                "A. k/r",
                "B. –k/r",
                "C. k/r²",
                "D. –k/r²",
        ...
        questionList.add(new Question("A body moves in a circular motion with velocity of 0.88m/s and a radius of 0.02m. Calculate the frequency",
                "A. 44Hz",
                "B. 7Hz",
                "C. 5Hz",
                "D. 22Hz",
        ...
        questionList.add(new Question("A body changed velocity from 15m/s to 45m/s in 5s. Calculate the acceleration",
                "A. 15m/s²",
                "B. 45m/s²",
                "C. 6m/s²",
                "D. 5m/s²",
        ...
        questionList.add(new Question("A person lifted a mass of20N through a height of 10m. Efficiency is 40%. Calculate work lost to friction.",
                "A. 200J",
                "B. 120J",
                "C. 80J",
                "D. 280J",
        ...
        questionList.add(new Question("A body of mass 50g is dropped from the top of ceiling to reach the ground within a second. Calculate the maximum potential energy of the body at the floor.",
                "A. 0J",
                "B. 256J",
                "C. 28J",
                "D. 15J",
        ...
        questionList.add(new Question("P1+(pv2)/2+pgh=P2+(pv2)/2+pgh\n" +
        ...
        questionList.add(new Question("Which of the following is not a natural force?",
                "A. Radioactive force",
        ...
        questionList.add(new Question("A force of 25N drags an through a distance of 10m with a frictional force of 7N. Calculate resultant work done.",
                "A. 180N",
                "B. 250N",
                "C. 70N",
                "D. 36N",
        ...
        questionList.add(new Question("Calculate the coefficient of friction, force is 140N and mass is 60kg",
                "A. 0.24",
                "B. 0.14",
                "C. 0.30",
                "D. 0.36",
    ...
    private void getQuestionPhase1(List<Question> list) {
        ...
        questionList.add(new Question("A mass of 50g is made to swing with a period of 1.7 seconds, calculate the force constant.  B",
                "A.  0.88N/m",
                "B. 0.68N/m",
                "C. 0.56N/m",
                "D. 0.78N/m",
        ...
        questionList.add(new Question("What is the time taken for an object starting from rest to attain a velocity of 60m/s if the acceleration is 14m/s^2",
                "A. 3.29s",
                "B. 4.26s",
                "C. 4.29s",
                "D. 3.33s",
        ...
        questionList.add(new Question("A tension of a wire of length 0.6m is 1.5N. Calculate the tension of a wire of length 0.4m",
                "A. 3.38N",
                "B. 4.38N",
                "C. 2.36N",
                "D. 1.38N",
        ...
        questionList.add(new Question("Which of the following is not a derived unit?",
                "A. steradian",
                "B. radian",
                "C. amphere",
                "D. Tesla",
        ...
        questionList.add(new Question("The force attracting on a body in a circular motion attracting opposite the center of rotation",
                "A. centripetal",
                "B. centrifugal",
                "C. tension",
                "D. gravitation",
        ...
        questionList.add(new Question("A square of side L is floating on the surface tension T. The force required to pull out the frame from the liquid",
                "A. 8TL",
                "B. 4TL",
                "C. 6TL",
                "D. 2TL",
        ...
        questionList.add(new Question("A mass of 25kg moving with 12m/s split into two masses m1 20kg and m2 5kg. If m1 moves with a velocity v1 10m/s, find the velocity at which m2 moves",
                "A. 20m/s",
                "B. 15m/s",
                "C. 12m/s",
                "D. 10m/s",
        ...
        questionList.add(new Question("A projectile is launched with speed Vo at an angle α. What is the expression for the time of flight?/s split into two masses m1 20kg and m2 5kg. If m1 moves with a velocity v1 10m/s, find the velocity at which m2 moves",
                "A. T= 2Vo sinα/g",
                "B. T= V²osinα/ 2g",
                "C. V²osinα/ g",
                "D. Vosin2α/g ",
        ...
        questionList.add(new Question("A body of mass 50g oscillates with an amplitude of 12cm and angular velocity of ω=3.986rad/s calculate the value when V is max",
                "A. 0.48m/s",
                "B. 0.12m/s",
                "C. 0.38m/s",
                "C. 0.26m/s",
        ...
        questionList.add(new Question("A mass 0.02kg on top if a cliff 40m high is thrown to reach the horizontal. What is the K.E",
                "A. 7.74J",
                "B. 7.84J",
                "C. 7.66J",
                "D. 7.60J",
        ...
        questionList.add(new Question("Which of the following is not correct about collision?",
        ...
        questionList.add(new Question("43. What happens in elastic collision\n" +
        ...
        questionList.add(new Question("The unit of pressure is",
                "A. kgms²",
                "B. Nm",
                "C. Ns",
                "D. N/m²",
        ...
        questionList.add(new Question("Which of the following types of motion are oscillatory?\n" +
        ...
        questionList.add(new Question("Relationship between Young modulus, stress and strain is given by",
        ...
        questionList.add(new Question("A heavy object is suspended from a string and lowered into water so that it is completely submerged. The object appears lighter because",
        ...
        questionList.add(new Question("An 80kg steel cylinder with a height of 2.0m has an area of 25cm². What is the pressure exerted by the cylinder on the floor.(take g=9.81m/s²)",
                "A. 3.1×10^5 Pa",
                "B. 3.2 ×10^-5 Pa",
                "C. 3.1×10^4 Pa",
                "D. 3.2×10^-4 Pa",
        ...
        questionList.add(new Question("If the energy E of a body depends on it's mass M and velocity V. Where K=constant. Which of the following expressions is correct.",
                "A. E=KMV²",
                "B. E=KMV-²",
                "C. E=KMV^3",
                "D. E=KMV^-3",
        ...
        questionList.add(new Question("A coiled elastic string has amplitude 12cm and a period of 1.7s and mass of 50g calculate the acceleration at 6cm?",
                "A. 1.42m/s²",
                "B. 1.53m/s²",
                "C. 1.26m/s²",
                "D. 1.36m/s²",
        ...
        questionList.add(new Question("Calculate the angle of oscillation of a pendulum if length of arc is 10cm and radius is 80cm",
                "A. 0.13°",
                "B. 7.2°",
                "C. 8.12°",
                "D. 6.25°",
        ...
        questionList.add(new Question("A body of radius 30cm moved with velocity of 15m/s during 8s, what is the angular acceleration?",
                "A. 1.88rad/s²",
                "B. 6.25rad/s²",
                "C. 2.36rad/s²",
                "D. 7.36rad/s²",
        ...
        questionList.add(new Question("If a body of mass 12.5g with initial velocity 10m/s and final velocity of 22.2m/s. Calculate the workdone",
                "A. 2.46J",
                "B. 3.45J",
                "C. 1.45J",
                "D. 2.67J",
        ...
        questionList.add(new Question("A mass of 15.2kg has a velocity of 12m/s and collides with a mass of 12.2kg and velocity of 20m/s. if they move in the same direction and the collision is inelastic. Calculate the energy lost as heat or sound",
                "A. 217J",
                "B. 225J",
                "C. 210J",
                "B. 180J",
        ...
        questionList.add(new Question("A body undergoing rotational motion from rest has an acceleration of 3.18rad/s² in 8s. Calculate the revolution in rad?",
                "A. 101.76",
                "B. 203.52",
                "C. 50.88",
                "D. 25.44",
        ...
        questionList.add(new Question("A body of mass 400g was extended by length of 35cm. Calculate the Spring Constant (Take g=9.8m/s)",
                "A. 11.2N/m",
                "B. 10.7N/m",
                "C. 5.6N/m",
                "D. 8.8N/m",
        ...
        questionList.add(new Question("Which of the following is correct about moment of inertia and mass\n" +
        ...
        questionList.add(new Question("For the period of pendulum bob given by T=mx ly gz. Find the values of x y and z",
                "A 0, ½, -½",
                "B ½, -½, ½ ",
                "C 0, 0, ½ ",
                "D ½, 0, ½ ",
        ...
        questionList.add(new Question("A body thrown with an initial velocity 135m/s at an angle of 45°. Calculate the maximum height attained",
                "A. 464.9m",
                "B 67.5m",
                "C 270m",
                "D 135.6m",
        ...
        questionList.add(new Question("A fan rotates at a angular frequency of 900rpm. If the distance from the center to the end of the arm of a blade is 20cm. Calculate its tangential velocity",
                "A. 127.60m/s",
                "B. 133.33m/s",
                "C. 171.89m/s",
                "D. 160.59m/s ",
        ...
        questionList.add(new Question("A cube has a length of 2cm and it's density is 6600g/cm³. What is the apparent mass when submerged in water. (Density of water=1000g/cm³)",
                "A. 13.2kg",
                "B. 8kg",
                "C. 6.6kg",
                "D. 4kg",
