...
public class Chm115Activity extends AppCompatActivity {
    ...
    private void setDataView(int position) {
        ...
        questionNo.setText(MessageFormat.format("Question {0} of 30", questionAnswered));
    ...
    private void getQuestionPhase(List<Question> list) {
        ...
        questionList.add(new Question("1. Calculate the concenteration in mol dm<sup>-3 </sup> of a solution containing 36.5g of \n" +
        ...
        questionList.add(new Question("2. 5.6g of Na<sub>2</sub> CO<sub>3</sub> was dissolved in 250cm<sup>3</sup> \n" +
        ...
        questionList.add(new Question("3. Why do you standardize the KMnO<sub>4</sub> solution before use in redox \n" +
                "experiment?",
        ...
        questionList.add(new Question("4. What amount in gram of potassium hydroxide must be weghed inorder to prepared 1.0 M \n" +
        ...
        questionList.add(new Question("5. Which of these is a suitable indicator for titration involving sodium hydroxide and \n" +
        ...
        questionList.add(new Question("6. To choose a suitable indicator for acid-base titration, it depends on ? ",
        ...
        questionList.add(new Question("7. A well labelled sample bottle describes ?",
        ...
        questionList.add(new Question("8. Indicator commonly used for potassium permanganate titration is ?",
                "redox indicator",
                "self indicator",
                "starch indicator",
                "starch indicator",
        ...
        questionList.add(new Question("9. During acid- base titration a point is reached when equivalent amounts of acid and base \n" +
        ...
        questionList.add(new Question("10. Calculate the amount in moles of solute in 250cm<sup>3</sup> of sodium hydroxide " +
        ...
        questionList.add(new Question("11. The oxidation state of Chlorine in HOCl<sub>2</sub> , HClO<sub>3</sub> and " +
        ...
        questionList.add(new Question("12. Reducing agent X reacts with oxidizing agent Y, the true statement is",
                "X is reduces",
                "Y is oxidises",
                "X gains electron",
                "Y gains election",
        ...
        questionList.add(new Question("13. Last drop at the pipette tip should not be blown to avoid <br /> <br /> I using more " +
        ...
        questionList.add(new Question("14. Arrange the following compounds of manganese in order of increasing oxidation state of " +
        ...
        questionList.add(new Question("15. Clamping the burette in vertical position is a precaution for which of the following " +
                "reasons? ",
                "To avoid leakage",
        ...
        questionList.add(new Question("16. Which of the followings affects the determination of density of gases and liquid?",
                "concentration",
                "temperature",
                "solubility",
                "pressure",
        ...
        questionList.add(new Question("17. What volume of 0.20M NaOH when diluted to 600cm<sup>3</sup> will produce a " +
        ...
        questionList.add(new Question("18. Which of the following correctly describe the use of a crucible in the laboratory? ",
                "To dry the sample",
                "To ash the sample",
        ...
        questionList.add(new Question("19. The following are true of complexometric titration except?",
        ...
        questionList.add(new Question("20. The number of molecules of the complexing agent is called?",
                "Ligand",
                "Stability constant",
                "Formation constant",
                "Lewis acid",
        ...
        questionList.add(new Question("21. The ligand often depend on <br /> <br /> I. The co-ordination number of the metal " +
        ...
        questionList.add(new Question("22. Ammonia is a simple complexing agent with one pair of unshared electrons that may " +
        ...
        questionList.add(new Question("23. Simple complexing agent such as ammonia are rarely used as titrating agents, because",
        ...
        questionList.add(new Question("24. An organic agent that has two or more groups capable of complexing with a metal ion is " +
                "called?",
                "a chelating agent",
                "a chelate",
                "a complex",
        ...
        questionList.add(new Question("25. Which of the following is not true of ethylenediamine tetra acetic acid?",
        ...
        questionList.add(new Question("26. Which of these is a suitable indicator used in complexometric titration?",
                "methyl orange",
                "Eriochrome Black T",
                "methyl red",
                "phenolphthalein",
        ...
        questionList.add(new Question("27. Consider the reaction: Zn + CuSO<sub>4</sub> &rarr; ZnSO<sub>4</sub> + Cu. " +
        ...
        questionList.add(new Question("28. A method of analysis yields weights for gold that are low by 0.3mg. Calculate the percent " +
                "relative error caused by this uncertainty if the weight of gold in the sample is 800mg./phases of conflict",
                "0.04%", "0.0375%",
                "0.038%", "-0.04%",
                "-0.04%"));

        questionList.add(new Question("29. Solution A is 0.050M HNO<sub>3</sub> and B is a solution of sodium carbonate. If " +
        ...
        questionList.add(new Question("30. 25cm<sup>3 </sup> of a solution containing 2.10g of sodium hydrogen carbonate was \n" +
    ...
    private void getQuestionPhase3(List<Question> list) {
        ...
        questionList.add(new Question("1. The true volume of a liquid is 2.55cm<sup>3</sup> and the measured value is \n" +
        ...
        questionList.add(new Question("2. Using an analytical procedure, the percentages of chloride (Cl<sup>-</sup>) content in a \n" +
        ...
        questionList.add(new Question("3. Calculate the relative error of the following set of data: 2.4, 2.1, 2.1 ,2.3, and 1.5 if the \n" +
        ...
        questionList.add(new Question("4. 25.0cm<sup>3</sup> of tetraoxosulphate(VI) acid requires 32.30cm<sup>3</sup> of \n" +
        ...
        questionList.add(new Question("5. The sum of 0.508, 110.1, and 21.27 gives",
                "131.878",
                "131.88",
                "131.9",
                "131.91",
        ...
        questionList.add(new Question("6. 1.5g of pyrite (impure FeS<sub>2</sub> ) is analysed for sulphur. If 1.14g of \n" +
        ...
        questionList.add(new Question("7. The Ksp of AgCl at 25<sup>o</sup> C is 1.0 x 10<sup>-10</sup> , calculate the molar \n" +
                "solubility of AgCl",
                "1.0 x 10<sup>-4</sup>",
                "1.0 x 10<sup>-5</sup>",
                "1.0 x 10<sup>-6</sup>",
        ...
        questionList.add(new Question("8. T4.00 g of sodium hydroxide is dissolved completely in 500cm<sup>3</sup> volumetric \n" +
        ...
        questionList.add(new Question("9. Round off 36.9645 and 297846 to five significant figures",
        ...
        questionList.add(new Question("10. Silver ion forms a stable 1: 1 complex with methylenetetramine called “trien” .Calculate \n" +
        ...
        questionList.add(new Question("11. The formation constant for CaY<sup>2-</sup> is 5.0 x 1010 .At pH 10, ? 4 is calculated to \n" +
        ...
        questionList.add(new Question("12. What must be the concentration of added Ag+ to just start the precipitation of AgCl in a \n" +
        ...
        questionList.add(new Question("13. 1500ml of a 15ppm solution of potassium hydroxide contains how many mg of potassium \n" +
                "hydroxide?",
                "30mg",
                "15mg",
                "22mg",
        ...
        questionList.add(new Question("14. Volumetric titration is best described as a class of experiment where <br /> <br /> I. A \n" +
        ...
        questionList.add(new Question("15. A sample of pure potassium chloride was analyzed for chloride ion (Cl<sup>-</sup> ) \n" +
        ...
        questionList.add(new Question("16. A is a solution of hydrochloric acid containing 1.825g per dm<sup>3</sup> of solution. B \n" +
        ...
        questionList.add(new Question("17. Calculate the mean and standard deviation of the following set of analytical results: \n" +
        ...
        questionList.add(new Question("18. Calculate the percent by weight of solution that weighs 200g and contains 25g of sodium \n" +
                "sulphate. ",
                "25% (w/v)",
                "12.5% (w/v)",
                "25%(w/w)",
        ...
        questionList.add(new Question("19. Consider the following set of data: 2.4, 2.1, 2.1, 2.3, and 1.5, Calculate the mean and \n" +
        ...
        questionList.add(new Question("20. If a 2.62g sample of material is analyzed to be 2.52g, what is the absolute error?",
                "0.10g",
                "2.08 and 0.08",
                "-0.01g",
                "0.100g",
        ...
        questionList.add(new Question("21. Manganese content of an earthcrust is determined by converting the Mn to \n" +
        ...
        questionList.add(new Question("22. Calculate the percentage of Ba in pure BaSO<sub>4</sub> ? ( Ba = 137.3, S=32, O=16)",
                "59%",
                "70%",
                "57%",
                "60%",
        ...
        questionList.add(new Question("23. Solution A is 0.050M H<sub>2</sub> SO<sub>4</sub> , B is a solution of sodium \n" +
        ...
        questionList.add(new Question("24. A titre value of 28.6cm<sup>3</sup> of a solution containing 0.4562g HCl per \n" +
        ...
        questionList.add(new Question("25. A loss of 0.4mg of Zn occurs in the course of an analysis for that element. Calculate the \n" +
        ...
        questionList.add(new Question("26. Solution E is 0.100M HCl. F is a solution of sodium carbonate. If 25cm<sup>3</sup> of F \n" +
        ...
        questionList.add(new Question("27. A solution with pH= 2 is more acidic than one with a pH=6 by a factor of? ",
                "4",
                "12",
                "400",
                "10,000",
        ...
        questionList.add(new Question("28. Evaluate the addition of 0.0631, 0.0226 and 0.0821 to the correct number of significant ",
                "1.01678",
                "0.01678",
                "400",
                "1.6780",
        ...
        questionList.add(new Question("29. A is a solution of hydrochloric acid containing 3.650g of HCl in 1dm<sup>3</sup> of \n" +
        ...
        questionList.add(new Question("30. Solution A contains 7.000g H<sub>2</sub> SO<sub>4</sub> in 1dm<sup>3</sup> and B \n" +
    ...
    private void getQuestionPhase4(List<Question> list) {
        ...
        questionList.add(new Question("1. Consider the following set of data: 4.4, 4.1, 4.2, 4.3, and 4.5, Calculate the absolute error " +
        ...
        questionList.add(new Question("2. A divalent metal M<sup>2+ </sup> reacts with a ligand L to form a 1: 1 complex. Calculate " +
        ...
        questionList.add(new Question("3. Gravimetric factor (GF) for the conversion of Ca2+ to CaC2O4 precipitate is <br /> <br /> \n" +
                "(Ca-40, C-12, 0-16)",
                "0.3125",
                "0.4125",
                "0.1125",
        ...
        questionList.add(new Question("4. Common determinate errors are --------- except?",
                "Accidental error",
                "Instrumental error",
                "Errors of methods",
                "Operative errors",
        ...
        questionList.add(new Question("5. The oxidation number of an element in an uncombined state is",
                "1",
                "2",
                "3",
                "0",
        ...
        questionList.add(new Question("6. C is a solution of hydrochloric acid containing 3.65g of HCl per dm<sup>3</sup> of \n" +
                "solution and D is a solution of impure sodium carbonate. If 25cm<sup>3</sup> of D requires \n" +
                "22.7cm<sup>3</sup> of C for complete reaction, what is the molarity and concentraion of sodium \n" +
                "carbonate?",
        ...
        questionList.add(new Question("7. In gravimetric determination, co-precipitated impurities can be removed by",
                "Peptization",
                "Washing",
                "Coagulation",
                "Post precipitation",
        ...
        questionList.add(new Question("8. Oxidation number of sulphur in Na<sub>2</sub>SO<sub>4</sub> is ?",
                "+6",
                "+8",
                "-6",
                "+5",
        ...
        questionList.add(new Question("9. A is a solution of hydrochloric acid containing 2.92mol per litre of solution and B is a " +
        ...
        questionList.add(new Question("10. Which of the following techniques can be a very selective process?",
                "gravimetric method",
        ...
        questionList.add(new Question("11. The titre value obtained in an acid-base titration of 25cm<sup>3</sup> of sodium \n" +
        ...
        questionList.add(new Question("12. Source of contamination of precipitate in gravimetric analysis could be from ?",
                "Washing",
                "Igniting",
                "Surface adsorption",
                "Weighing",
        ...
        questionList.add(new Question("13. The quantitative determination of a substance by precipitation followed by isolation and " +
        ...
        questionList.add(new Question("14. The following factors are needed for achieving selectivity in complexometric titrations " +
                "except ",
        ...
        questionList.add(new Question("15. The following requirements must be met for a successful gravimetric determination " +
                "except",
        ...
        questionList.add(new Question("16. Which of these is not true of the primary adsorbed ion? ",
        ...
        questionList.add(new Question("17. Which of the following is not included in the group of analyses based on the amount of \n" +
                "sample taken?",
                "macroanalyses",
        ...
        questionList.add(new Question("18. Express 3.00g/ml x1.207ml to the correct number of significant figures.",
                "3.62g",
                "3.621g",
                "3.62g/ml",
                "3.621g/ml",
        ...
        questionList.add(new Question("19. The following statements are true about random error except",
        ...
        questionList.add(new Question("20. Chloride ion in 3.10g iron III chloride sample is converted to the hydrous <br /> <br /> \n" +
        ...
        questionList.add(new Question("21. The experimental error in which its source cannot be traced is known as",
                "definite error",
        ...
        questionList.add(new Question("22. The error in weighing an hygroscopic sample can be described by all the following except " +
                "one.",
                "Systematic error",
                "Determinate error",
                "Positive error",
        ...
        questionList.add(new Question("23. In gravimetric analysis, measurement are based on?",
                "volume",
                "density",
                "mass",
                "pressure",
        ...
        questionList.add(new Question("24. In precipitation gravimetric methods, analyte is converted to",
        ...
        questionList.add(new Question("25. In the precipitation of chloride ion as silver chloride, all these ions are interferences " +
                "except?",
                "Cyanide ion",
                "Nitrate ion",
                "Bromide ion",
        ...
        questionList.add(new Question("26. The first step in precipitation is the formation of very tiny particles of precipitate called " +
        ...
        questionList.add(new Question("27. The following are correct on counter ion except? ",
                "Held by chemical bond",
                "Held by electrostatic attraction",
        ...
        questionList.add(new Question("28. The Ksp for the ionization of AgCl in water is given by",
                "[H+][ Cl-]",
                "[Ag+][ OH-]",
                "[Ag+][ Cl-]",
                "[H+][ OH-] ",
        ...
        questionList.add(new Question("29. The titration useful for determining chloride in neutral or unbuffered solutions such as \n" +
                "drinking water is?",
                "Volhard titration",
                "Acid- base",
        ...
        questionList.add(new Question("30. Standardization of KMnO<sub>4</sub> solution by sodium oxalate " +
    ...
    private void getQuestionPhase5(List<Question> list) {
        questionList.add(new Question("1. In the Mohr titration, the ideal pH is ?",
                "2",
                "12",
                "8",
                "5",
        ...
        questionList.add(new Question("2. ..................... method is the most recent and accurate among the precipitation titration \n" +
                "methods?",
                "Adsorption indicator",
                "Mohr",
                "Volhard",
        ...
        questionList.add(new Question("3. In the Mohr titration method, the chloride is titrated with standard AgNO<sub>3</sub> " +
        ...
        questionList.add(new Question("4. Completeness of a precipitate reaction is determined by?",
        ...
        questionList.add(new Question("5. The p- function is ",
        ...
        questionList.add(new Question("6. The different types of precipitation titrations include all except",
                "Mohr",
                "Adsorption indicators",
                "Fajans",
                "None of the above",
                "None of the above"));
        questionList.add(new Question("7. In Mohr titration, there is precipitation of some ---- with more alkaline solutions.",
                "Silver carbonate",
                "silver hydroxide",
        ...
        questionList.add(new Question("8. Precipitating reagent should react with the analyte",
        ...
        questionList.add(new Question("9. Precipitate must be",
        ...
        questionList.add(new Question("10. In the titration of Silver nitrate with chloride ion during precipitation titration, before the \n" +
        ...
        questionList.add(new Question("11. The pH at equivalence point of a weak acid / strong base titration depends on <br /> <br \n" +
        ...
        questionList.add(new Question("12. The pH at equivalence point of a weak acid / strong base titration depends on <br /> <br \n" +
                "/> I. The dissociation constant and concentration of the weak species <br /> <br /> II. The " +
                "dissociation constant and concentration of the strong species. <br /> <br /> III. The dissociation " +
                "constant of the acid and concentration of the base <br /> <br /> IV. The dissociation constant of " +
                "the base and the concentration of the acid",
        ...
        questionList.add(new Question("13. An ultrapure compound that serves as the reference materials for a titrimetric method of \n" +
        ...
        questionList.add(new Question("14. The volume of a cylindrical rod is given by the equation V= &pi;r<sup>2</sup> h, where r \n" +
        ...
        questionList.add(new Question("15. The following statement is/are true of indicator behavior in an <br /> <br /> acid/base \n" +
        ...
        questionList.add(new Question("16. Which of these is not a unit of concentration?",
                "mg/L",
                "ppm",
                "normality",
                "moles",
        ...
        questionList.add(new Question("17. Which of the following statement is true of end-point of acid-base titration ; <br /> <br /> " +
        ...
        questionList.add(new Question("18. What marks the sudden change in oxidation potential <br /> in the neighbourhood of the " +
        ...
        questionList.add(new Question("19. An acid – base indicator <br /> <br /> I. Is an organic dyes which are weak acids having " +
        ...
        questionList.add(new Question("20. A primary standard solution is one which contains <br /> <br /> I. A known amount of " +
        ...
        questionList.add(new Question("21. Titration of 0.1M ammonia with 0.1M hydrochloric acid solution may occur at equivalence " +
                "point of between ?",
                "5 - 6",
                "6 - 7",
                "7 - 8",
        ...
        questionList.add(new Question("22. During a typical acid - base titration, which of these colour changes would be observed at " +
        ...
        questionList.add(new Question("23. During a typical acid - base titration, which of these colour changes would be observed at " +
        ...
        questionList.add(new Question("24. At what pH range is expected for methyl orange indicator to change from red to yellow " +
        ...
        questionList.add(new Question("25. Which of the following indicator is suitable for the titration of ethanedioic acid with " +
        ...
        questionList.add(new Question("26. Calculate the average titre value from these sets of volume of acid used in a typical acid -" +
        ...
        questionList.add(new Question("27. In acid - base titration of NaOH versus HCl, methyl red indicator changes colour from",
                "pink-red",
                "pink-yellow",
                "red-yellow",
                "yellow-red",
        ...
        questionList.add(new Question("28. Which of these indicators can be used for a weak acid and a weak base?",
        ...
        questionList.add(new Question("29. Potassium permanganate solution is normally stored in ?",
                "White bottle",
                "Yellow bottle",
                "Brown bottle",
                "Pink bottle",
        ...
        questionList.add(new Question("30. Which of these pair compounds have the same oxidation states with that of common " +
                "elements? ",
